...
t = function() {
    ...
    let c = t, l = e, a = !!c.document, s = !!l.documentElement && !!l.head && "function" == typeof l.addEventListener && "function" == typeof l.createElement;
    ...
    s && !(u = (l.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(l.readyState)) && l.addEventListener("DOMContentLoaded", f);
    ...
    (function(t) {
        ...
        function a(t, e) {
            ...
            for (r[15] = a[15] = void 0, 16 < o.length && (o = i(o, 8 * t.length)), 
            n = 0; n < 16; n += 1) r[n] = 909522486 ^ o[n], a[n] = 1549556828 ^ o[n];
    ...
    var g = n.exports;
    function m(t) {
        if (null !== t && "object" == typeof t) return t.src ? g(t.src) : t.href ? g(t.href) : t.innerText && "" !== t.innerText ? g(t.innerText) : void 0;
    }
    let b = "fsz-kits-diag", w = "fsz-kits-node-under-test", y = "data-md5", v = "data-fsz-detection-ignore", A = "data-fsz-detection-timeout", x = "data-fsz-detection-results-collection-max-wait", T = t => {
    ...
    function E(t) {
        ...
        c.FontAwesomeDetection = c.FontAwesomeDetection || {}, c.FontAwesomeDetection.nodesTested = t, 
        c.FontAwesomeDetection.nodesFound = e, c.FontAwesomeDetection.detectionDone = !0;
    }
    function O(t) {
        ...
        c.onmessage = function(t) {
            "file://" !== c.location.origin && t.origin !== c.location.origin || t && t.data && ("fontawesome-conflict" === t.data.type ? n.conflict[t.data.md5] = t.data : "no-conflict" === t.data.type && (n.noConflict[t.data.md5] = t.data));
        };
        var t = (e => {
            var r = Array.from(l.scripts).filter(t => !t.hasAttribute(v) && t !== e), a = {};
            for (let o = 0; o < r.length; o++) {
                let t = l.createElement("iframe"), e = (t.setAttribute("style", "display:none;"), 
                l.createElement("script"));
                e.setAttribute("id", w);
                var i = m(r[o]);
                e.setAttribute(y, i), a[i] = r[o], "" !== r[o].src && (e.src = r[o].src), 
                "" !== r[o].innerText && (e.innerText = r[o].innerText), e.async = !0;
                ...
                }).toString(), ")('").concat(w, "', '").concat(i, "', '").concat(s, "');"), 
                t.onload = function() {
                    t.contentWindow.addEventListener("error", T, !0), t.contentDocument.head.appendChild(n), 
                    t.contentDocument.head.appendChild(e);
                }, h(() => l.body.appendChild(t));
            }
            return a;
        })(l.currentScript), o = (() => {
            var e = Array.from(l.getElementsByTagName("link")).filter(t => !t.hasAttribute(v)), n = Array.from(l.getElementsByTagName("style")).filter(t => !(t.hasAttribute(v) || c.FontAwesomeConfig && t.innerText.match(new RegExp("svg:not\\(:root\\)\\.".concat(c.FontAwesomeConfig.replacementClass)))));
            function o(t, e) {
                let n = l.createElement("iframe");
                n.setAttribute("style", "visibility: hidden; position: absolute; height: 0; width: 0;");
                var o = "fsz-test-icon-" + e;
                let r = l.createElement("i"), a = (r.setAttribute("class", "fa fsz-coffee"), 
                r.setAttribute("id", o), l.createElement("script"));
                a.setAttribute("id", b);
                ...
                }).toString(), ")('").concat(w, "', '").concat(o || "foo", "', '").concat(e, "', '").concat(i, "');"), 
                n.onload = function() {
                    n.contentWindow.addEventListener("error", T, !0), n.contentDocument.head.appendChild(a), 
                    n.contentDocument.head.appendChild(t), n.contentDocument.body.appendChild(r);
                }, h(() => l.body.appendChild(n));
            }
            var r = {};
            for (let t = 0; t < e.length; t++) {
                var a = l.createElement("link"), i = (a.setAttribute("id", w), a.setAttribute("href", e[t].href), 
                a.setAttribute("rel", e[t].rel), m(e[t]));
                a.setAttribute(y, i), r[i] = e[t], o(a, i);
            }
            for (let t = 0; t < n.length; t++) {
                var s = l.createElement("style"), f = (s.setAttribute("id", w), 
                m(n[t]));
                s.setAttribute(y, f), s.innerText = n[t].innerText, r[f] = n[t], 
                o(s, f);
            }
            return r;
        })();
        let r = i(i({}, t), o), a = Object.keys(t).length + Object.keys(o).length;
        t = c.FontAwesomeDetection.timeout + c.FontAwesomeDetection.resultsCollectionMaxWait;
        console.group("Font Awesome Detector"), 0 === a ? (console.info("%cAll Good!", "color: green; font-size: large"), 
        console.info("We didn't find anything that needs testing for conflicts. Ergo, no conflicts.")) : (console.info("Testing ".concat(a, " possible conflicts.")), 
        ...
        console.info("\t%c".concat(x, "%c: milliseconds to wait for the browser to accumulate test results before giving up."), "font-weight: bold;", "font-size: normal;"), 
        D({
            maxDuration: t,
            showProgress: !0,
            progressIndicator: "waiting...",
            fn: () => Object.keys(n.conflict).length + Object.keys(n.noConflict).length >= a
        }).then(() => {
            console.info("DONE!"), E({
                nodesTested: n,
                nodesFound: r
    ...
    var n = c.FontAwesomeDetection || {}, n = i(i(i({}, {
        report: function(t) {
            var e, {
                nodesTested: n,
                nodesFound: o
        ...
        resultsCollectionMaxWait: +(l.currentScript.getAttribute(x) || "5000")
    }), n), {}, {
        __pollUntil: D,
        md5ForNode: m,
        detectionDone: !1,
