...
(function (global, factory) {
  ...
  const diagScriptId = 'fsz-kits-diag';
  const nodeUnderTestId = 'fsz-kits-node-under-test';
  const md5Attr = 'data-md5';
  const detectionIgnoreAttr = 'data-fsz-detection-ignore';
  const timeoutAttr = 'data-fsz-detection-timeout';
  const resultsCollectionMaxWaitAttr = 'data-fsz-detection-results-collection-max-wait';
  ...
  function detectWebfontConflicts() {
    ...
    function runDiag(scriptOrLinkTag, md5) {
      ...
      const testIconId = 'fsz-test-icon-' + md5;
      const iTag = DOCUMENT.createElement('i');
      iTag.setAttribute('class', 'fa fsz-coffee');
